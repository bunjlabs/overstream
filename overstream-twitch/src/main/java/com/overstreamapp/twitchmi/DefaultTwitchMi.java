...
public class DefaultTwitchMi implements TwitchMi {
    ...
    @Inject
    public DefaultTwitchMi(Logger logger, TwitchMiSettings settings, EventLoopGroupManager loopGroupManager, WebSocketClient webSocketClient) {
        this.logger = logger;
    ...
    private class Handler implements WebSocketHandler {
        ...
        public void onOpen(WebSocket webSocket) {
            ...
            DefaultTwitchMi.this.state = ConnectionState.CONNECTED;
