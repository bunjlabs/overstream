...
public class TwitchBotAppModule  implements AppModule {

    private final GroovyRuntime groovyRuntime;

    @Inject
    public TwitchBotAppModule(GroovyRuntime groovyRuntime) {
        this.groovyRuntime = groovyRuntime;
    }

    @Override
    public List<Unit> getUnits() {
        return Arrays.asList(new TwitchBotUnit(), new TwitchMiUnit());
    }

    @Override
    public void init(Injector injector) {
        groovyRuntime.export("TwitchBot", injector.getInstance(TwitchBot.class));
        groovyRuntime.export("TwitchMi", injector.getInstance(TwitchMi.class));
    }
}
