...
public class StreamlabsAppModule implements AppModule {

    private final GroovyRuntime groovyRuntime;

    @Inject
    public StreamlabsAppModule(GroovyRuntime groovyRuntime) {
        this.groovyRuntime = groovyRuntime;
    }

    @Override
    public List<Unit> getUnits() {
        return Collections.singletonList(new StreamlabsUnit());
    }
