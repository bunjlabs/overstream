...
public class MessageServer {
    ...
    @Inject
    public MessageServer(Logger log, AppInfo appInfo, WebSocketServer webSocketServer, EventKeeper eventKeeper, StoreKeeper storeKeeper, TypeConverter conv, MessageServerSettings settings) {
        this.log = log;
        ...
        this.connectionEvent = eventKeeper.eventBuilder(NewConnectionEvent.class).build();
    }
